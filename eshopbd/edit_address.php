...
<body class="js">
    ...
    $query = "SELECT * from customer where customer_id=$custom_id ";
    ...
    <div class="row" style="margin: 10% 0;">
        ...
        <div class="col-md-8">
            <main>
                ...
                <h2 style="margin-left: 85px;">Edit Address</h2>
                <form name="book_details" action="edit_address_connect.php" method="post" style="margin:4% 0;">
                    <div class="row mx-auto">
                        <div class="col-lg-4 col-md-5 col-sm-11 col-xl-4 mx-auto">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="fname" value="<?php echo $rows1['first_name']; ?> " name="fname" required>
                            </div>
                            <div class="form-group">
                                <label for="lname"><span style="color:#FF0000">*</span> Last Name</label>
                                <input type="text" class="form-control" id="lname" value="<?php echo $rows1['last_name']; ?>" name="lname" required>
                            </div>

                            <div class="form-group">
                                <label for="email"><span style="color:#FF0000">*</span> Email</label>
                                <div>
                                    <input type="email" class="form-control from-control-login" id="email" value="<?php echo $rows1['email']; ?>" name="email" required>
                        ...
                        <div class="col-lg-4 col-md-5 col-sm-11 col-xl-4 mx-auto">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="cname" value="<?php echo $rows1['phone']; ?>" name="phone" required>
                            </div>
                            <div class="form-group">
                                <label for="add1"><span style="color:#FF0000">*</span> Address</label>
                                <input type="text" class="form-control" id="add1" value="<?php echo $rows1['Address']; ?>" name="add1" required>
                            </div>
                            <div class="form-group">
                                <label for="add1"><span style="color:#FF0000">*</span>Billing address</label>
                                <input type="text" class="form-control" id="add1" value="<?php echo $rows1['billing_address']; ?>" name="add2" required>
                            </div>
                            <div class="form-group">
                                <label for="city"><span style="color:#FF0000">*</span> City</label>
                                <input type="text" class="form-control" id="city" value="<?php echo $rows1['city']; ?>" name="city" required>
                            </div>
                            <div class="form-group">
                                ...
                                <select class="form-control" id="country" name="country">
                                    ...
                                    <option> <?php echo $rows1['country']; ?></option>
