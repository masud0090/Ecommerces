		...
		<div class="container">
			<div class="row">
					...
					<div class="shop-sidebar">
						...
						<div class="single-widget category">
							...
							<ul class="categor-list">
								...
								?>
									<li class="typelist"><a><?php echo $data1['s_name']; ?><span class="type"><?php echo $data1['sub_cat_id']; ?></span></a></li>
								<?php } ?>
							</ul>
						</div>
						<!--/ End Single Widget -->
				...
				<div class="col-lg-9 col-md-8 col-12">
					...
					<?php
					$p_c_id = $_GET['catid'];
					//$sql2="SELECT * FROM product INNER JOIN sub_category ON product.sub_cat_id=sub_category.sub_cat_id WHERE sub_category.sub_cat_id='{$p_c_id}'";
					$sql2 = "SELECT * FROM sub_category WHERE cat_id='{$p_c_id}'";
					...
					<div class="row type-data">
						...
						while ($data2 = mysqli_fetch_assoc($result2)) {
							$subcategory_id = $data2['sub_cat_id'];
							//$sql2="SELECT * FROM product INNER JOIN sub_category ON product.sub_cat_id=sub_category.sub_cat_id WHERE sub_category.sub_cat_id='{$p_c_id}'";
							$sql3 = "SELECT * FROM product WHERE sub_cat_id='{$subcategory_id}'";
									...
									<div class="single-product">
										<div class="product-img">
											<a href="#" style="width:80%;height:30vh;">
												...
												<img src="uploads/<?php echo $data3['image']; ?>" alt="#">
											</a>
										...
										<div class="product-content">
											<h3><a href="product-details.html"><?php echo $data3['p_name']; ?></a></h3>
