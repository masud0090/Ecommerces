						...
						<div class="flex-w flex-t bor12 p-t-15 p-b-30">
							...
							<div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
								...
								<div class="p-t-15">
									...
									$sql="select Address,phone, concat(concat(first_name, ' '), last_name) as fullname from customer where customer_id=$custom_id";
									...
									<div class="bor8 bg0 m-b-22">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="name" value="<?php echo $name ?>">
									</div>
								
									<div class="bor8 bg0 m-b-12">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="address" value="<?php echo $address ?>">
									</div>
									

									<div class="bor8 bg0 m-b-22">
										<input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" name="phone" value="<?php echo $phone ?>">
									</div>
