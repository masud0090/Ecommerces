...
if (isset($_POST['submit1'])) {
    ...
    $sql = "update customer set first_name='$fnm', last_name='$lnm',email='$email',phone='$phn', Address='$addr',billing_address='$biladdr', city='$cty',country='$count' where customer_id='$custom_id'";
